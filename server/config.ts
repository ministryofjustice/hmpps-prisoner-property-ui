...
export default {
  ...
  apis: {
    ...
    prisonerPropertyApi: {
      url: get('PRISONER_PROPERTY_API_URL', 'http://localhost:8080', requiredInProduction),
      healthPath: '/health/ping',
      timeout: {
        response: Number(get('PRISONER_PROPERTY_API_TIMEOUT_RESPONSE', 5000)),
        deadline: Number(get('PRISONER_PROPERTY_API_TIMEOUT_DEADLINE', 5000)),
      },
