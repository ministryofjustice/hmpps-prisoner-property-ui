...
export default class RemoveContainerCheckAnswersPage extends AbstractPage {
  ...
  static async verifyOnPage(page: Page): Promise<RemoveContainerCheckAnswersPage> {
    const checkPage = new RemoveContainerCheckAnswersPage(page)
